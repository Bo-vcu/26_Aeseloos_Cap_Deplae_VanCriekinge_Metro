...
public class TicketPriceFactory {
    ...
    public TicketPrice newTicket(TicketPriceDiscountEnum discount) throws InstantiationException, IllegalAccessException {
        return discount.getTicketPrice().newInstance();
    }
